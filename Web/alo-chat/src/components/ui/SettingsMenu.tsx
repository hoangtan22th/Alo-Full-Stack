...
export default function SettingsMenu({ onClose, onOpenGeneralSettings }: SettingsMenuProps) {
  const menuItems = [
    ...
    { name: 'Đăng xuất', icon: ArrowLeftOnRectangleIcon, color: 'text-red-500' },
  ];

  return (
    <div className="absolute left-[60px] bottom-0 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 animate-in fade-in slide-in-from-left-2 duration-200">
      <div className="px-4 py-2 border-b border-gray-100 mb-1">
        <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Tùy chỉnh</span>
      </div>
