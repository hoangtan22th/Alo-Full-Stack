    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm">
      ...
      */}
      <div className="flex w-[850px] h-[600px] bg-white text-gray-900 rounded-lg overflow-hidden shadow-2xl border border-gray-200">
        ...
        */}
        <div className="w-[280px] bg-[#f4f5f7] border-r border-gray-200 p-4">
          ...
          <div className="p-8 overflow-y-auto">
            {activeTab === 'general' && (
              <div className="space-y-8">
                <section>
                  <h3 className="text-lg font-semibold mb-4 text-gray-950">Danh bạ</h3>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-4 shadow-sm">
                    <label className="flex items-center justify-between cursor-pointer group py-1">
                      <span className="text-gray-800 group-hover:text-gray-950">Hiển thị tất cả bạn bè</span>
                ...
                <section>
                  <h3 className="text-lg font-semibold mb-4 text-gray-950">Ngôn ngữ</h3>
            ...
            {activeTab !== 'general' && (
              ...
              <div className="flex items-center justify-center h-full text-gray-400">
                Đang phát triển tính năng {menuItems.find(i => i.id === activeTab)?.name}...
              </div>
            )}
          </div>
        </div>
