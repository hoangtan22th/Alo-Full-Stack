    ...
    <div className="flex-1 h-screen bg-[#fafafa] p-8 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {requests.map((req: any) => (
          ...
          >
            <div className="w-20 h-20 bg-blue-50 rounded-full mb-4 flex items-center justify-center font-bold">
              Avatar
            </div>
            ...
            <div className="flex gap-3 w-full mt-auto">
              <button className="flex-1 bg-black text-white py-2.5 rounded-full font-semibold">
                Đồng ý
              </button>
              <button className="flex-1 bg-gray-100 text-gray-800 py-2.5 rounded-full font-semibold">
                Từ chối
              </button>
            </div>
          </div>
