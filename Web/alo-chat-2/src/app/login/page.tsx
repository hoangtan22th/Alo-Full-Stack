      ...
      <div className="bg-white border border-gray-100 rounded-[40px] shadow-2xl max-w-5xl w-full p-8 md:p-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center min-h-150">
        ...
        <div className="hidden md:flex flex-col items-center justify-center bg-gray-50/50 rounded-[35px] p-12 aspect-square border border-gray-50 relative">
          ...
          <div className="bg-white p-6 rounded-[30px] shadow-xl mb-6 border border-gray-100/50">
            <div className="w-44 h-44 flex items-center justify-center overflow-hidden relative group">
              {qrToken ? (
                <QRCodeSVG
                  ...
                  level="H"
                  includeMargin={false}
                  className={`transition-all duration-500 ${qrStatus === "SCANNED" ? "blur-sm scale-95 opacity-50" : "scale-100 opacity-100"}`}
                />
              ) : (
          ...
          <p className="text-gray-400 text-center text-sm max-w-62.5 mb-8 font-medium leading-relaxed">
