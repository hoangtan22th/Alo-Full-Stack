...
import axiosClient from "@/services/api"; // Dùng axiosClient thay cho fetch localhost
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-white w-full max-w-100 h-auto max-h-[85vh] flex flex-col rounded-[28px] shadow-2xl relative animate-in zoom-in-95 duration-200 overflow-hidden"
      >
          ...
          <div className="px-6 py-5 relative bg-white flex-1">
            <div className="flex flex-col items-center -mt-16 mb-6">
              <div className="relative">
                ...
                <div className="w-24 h-24 rounded-full border-4 border-white overflow-hidden shadow-lg bg-black">
                  <img
                    src={avatarUrl}
